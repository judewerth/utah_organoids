...
schema = dj.schema(DB_PREFIX + "selection")


@schema
class FrameParamset(dj.Lookup):
    """
...
class FrameAnalysis(dj.Computed):
    ...
    def make(self, key):
        ...
        num_frames, min_per_frame = (FrameParamset & key).fetch1('num_frames', 'min_per_frame')
